...
const locatorsData = [
  // Delhi
  {
    ...
    details: {
      ...
      services: [
        { name: "Grocery", price: "Varies", description: "Fresh produce and packaged foods" },
        { name: "Household", price: "Varies", description: "Cleaning supplies and home essentials" },
        { name: "Personal Care", price: "Varies", description: "Beauty and hygiene products" }
      ],
      promos: [
  ...
  },
  {
    ...
    details: {
      ...
      services: [
        { name: "Whopper Meal", price: "₹199-₹299", description: "Signature burger with fries and drink" },
        { name: "Chicken Fries", price: "₹129-₹179", description: "Crispy chicken strips" },
        { name: "Veggie Burger", price: "₹99-₹149", description: "Delicious plant-based option" }
      ],
      promos: [
  ...
  },
  {
    ...
    details: {
      ...
      description: "India's premier electronics retailer offering the latest gadgets, appliances, and smart home solutions with expert advice and installation services.",
      address: "8, Nehru Place, Delhi - 110019",
      ...
      facilities: [
        { name: "Expert Advice", description: "Knowledgeable staff to guide you" },
        { name: "Installation", description: "Professional setup services" },
        { name: "EMI Options", description: "Easy financing available" }
      ],
      services: [
        { name: "TV Installation", price: "₹500-₹2000", description: "Wall mounting and setup" },
        { name: "AC Service", price: "₹800-₹1500", description: "Maintenance and repair" },
        { name: "Smart Home Setup", price: "₹2000+", description: "Complete automation solutions" }
      ],
      promos: [
        { name: "Festival Discount", description: "10% off on all electronics", code: "DIGITAL10" }
      ],
      support: {
      ...
      reviews: "3500+",
      established: "2007",
      tags: ["Gadgets", "Appliances", "Smart Home"]
    }
  },
  // Mumbai
  {
    ...
    details: {
      name: "Dmart Andheri",
      image: "https://www.projectsmonitor.com/wp-content/uploads/2021/09/@DMartOfficiall.jpg",
      description: "Popular discount supermarket offering groceries, household items and daily essentials at unbeatable prices in Andheri West.",
      address: "45, Andheri West, Mumbai - 400058",
      timings: "Mon-Sun: 9 AM - 10 PM",
      entryFee: "Free Entry",
      mapLink: "https://maps.example.com/dmart-andheri",
      website: "https://www.dmart.in",
      images: [
        "https://www.projectsmonitor.com/wp-content/uploads/2021/09/@DMartOfficiall.jpg",
        "https://www.goodreturns.in/img/1200x60x675/2020/04/dmart-1525851463-1586576977.jpg"
      ...
      facilities: [
        ...
        { name: "AC Shopping", description: "Comfortable air-conditioned environment" },
        { name: "Wheelchair Access", description: "Accessible for all customers" }
      ],
      services: [
        { name: "Grocery", price: "Varies", description: "Wide range of food items" },
        { name: "Home Needs", price: "Varies", description: "Cleaning and household supplies" },
        { name: "Personal Care", price: "Varies", description: "Health and beauty products" }
      ],
      promos: [
        { name: "New Customer", description: "5% off first purchase", code: "NEWDMART" }
      ],
      support: {
        email: "support@dmart.com",
        phone: "+91-1234567891",
      ...
      reviews: "1800+",
      established: "2015",
      tags: ["Supermarket", "Discount", "Essentials"]
    }
  },
  {
    category: "Food",
    metropolis: "Mumbai",
    details: {
      name: "Burger King Bandra",
      image: "https://chawil.com/wp-content/uploads/2022/12/Burger-King-Logo.png",
      description: "Famous American fast food chain serving flame-grilled burgers, crispy fries and refreshing beverages in Bandra West.",
      address: "33, Linking Road, Bandra West, Mumbai - 400050",
      timings: "10 AM - 12 AM (All Days)",
      entryFee: "No Cover Charge",
      mapLink: "https://maps.example.com/burgerking-bandra",
      website: "https://www.burgerking.in",
      images: [
        "https://example.com/burgerking1.jpg",
        "https://example.com/burgerking2.jpg"
      ...
      facilities: [
        { name: "Late Night", description: "Open till midnight" },
        { name: "Drive-Thru", description: "Convenient car service" },
        { name: "Free WiFi", description: "High-speed internet access" }
      ],
      services: [
        { name: "Whopper Meal", price: "₹199-₹299", description: "Signature burger combo" },
        { name: "Chicken Nuggets", price: "₹129-₹179", description: "Crispy chicken bites" },
        { name: "Veggie Burger", price: "₹99-₹149", description: "Delicious plant-based option" }
      ],
      promos: [
        { name: "Student Discount", description: "10% off for students", code: "STUDENT10" }
      ],
      support: {
        email: "support@burgerking.com",
        phone: "+91-9876543212",
  ...
  // Bangalore
  {
    ...
    details: {
      ...
      services: [
        { name: "Product Demo", price: "Free", description: "Hands-on experience" },
        { name: "Home Delivery", price: "Free/Paid", description: "Safe product transportation" },
        { name: "Installation", price: "Varies", description: "Professional setup services" }
      ],
      promos: [
    ...
    <div class="store-content">
      ...
      <div class="store-hero">
        <div class="store-image-container">
          <img src="${store.details.image}" alt="${store.details.name}" class="store-image">
        </div>
      ...
      <div class="store-services-section">
        ...
        <div class="services-grid">
          ${store.details.services?.map(service => `
